...
var CustomAssertHelper = function () {
    ...
    this.arrayComparisionAssert = function (var1, var2, isContainOperation, transformation) {
        ...
        if ((var1JsonValue.length != var2JsonValue.length || colIndexes1.length != colIndexes2.length) && !isContainOperation) {
            ...
            var forwardTrace = this.checkValueExist(var1JsonValue, var2JsonValue, colIndexes1, colIndexes2, transformation);
            var backwardTrace = forwardTrace && !isContainOperation ? this.checkValueExist(var2JsonValue, var1JsonValue, colIndexes2, colIndexes1, transformation) : false;
    ...
    this.checkValueExist = function (array1, array2, array1ColIndex, array2ColIndex, transformation) {
