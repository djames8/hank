    ...
    public class AutoMapperBootstraper
    {
        ...
        private static void MappingLookupDbToDto()
        {
            ...
            AutoMapper.Mapper.CreateMap<TblTicketMaster, TblTicketMasterDto>()
                .ForMember(x => x.CreatedByFullName, opt => opt.MapFrom(src => src.CreatedByUser != null ? src.CreatedByUser.FullName : null))
                .ForMember(x => x.AssignedToFullName, opt => opt.MapFrom(src => src.AssignedToUser != null ? src.AssignedToUser.FullName : null))
                .ReverseMap();
            AutoMapper.Mapper.CreateMap<TblTicketHistory, TblTicketHistoryDto>()
                .ForMember(x => x.CreatedByFullName, opt => opt.MapFrom(src => src.CreatedByUser != null ? src.CreatedByUser.FullName : null)).ReverseMap();
            ...
            AutoMapper.Mapper.CreateMap<TblTestData, TblTestDataDto>()
                .ForMember(x => x.ModifiedByUserName, opt => opt.MapFrom(src => src.ModifiedByUser != null ? src.ModifiedByUser.FirstName : null))
                .ForMember(x => x.TestName, opt => opt.MapFrom(src => src.Test != null ? src.Test.TestName : null))
            ...
            AutoMapper.Mapper.CreateMap<TblSharedTestDataDto, TblTestDataDto>()
                ...
                .ForMember(x => x.SharedStepWebsiteTestId, opt => opt.MapFrom(src => src.ReportDataTestId < 0 ? 0 : src.ReportDataTestId))
                .ReverseMap();
            ...
            AutoMapper.Mapper.CreateMap<TblReportExecutionLinkData, TblReportExecutionLinkDataDto>()
              .ReverseMap();

            AutoMapper.Mapper.CreateMap<TblTransformationCategory, TblTransformationCategoryDto>()
              .ReverseMap();

            AutoMapper.Mapper.CreateMap<TblTransformation, TblTransformationDto>()
             .ReverseMap();
        }
    }
}